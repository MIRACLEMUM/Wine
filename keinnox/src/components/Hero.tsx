    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
          Discover our curated collection of the world's finest wines,
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#products"
            className="px-8 py-4 bg-amber-500 text-black font-semibold rounded-lg hover:bg-amber-400 transition transform hover:scale-105 inline-flex items-center justify-center gap-2"
          >
            Explore Collection
